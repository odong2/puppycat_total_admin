package com.architecture.admin.models.dto.wordcheck.pet;
...
@ExcelFileName(filename = "lang.wordcheck.pet.title.list")
public class PetWordCheckDto implements ExcelDto {
    ...
    public List<Object> mapToList() {
        return Arrays.asList(idx, word, stateText, typeText, memo, adminId, regDate);
    }
