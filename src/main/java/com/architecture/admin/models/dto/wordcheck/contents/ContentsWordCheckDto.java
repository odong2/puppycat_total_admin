package com.architecture.admin.models.dto.wordcheck.contents;
...
@ExcelFileName(filename = "lang.wordcheck.contents.title.list")
public class ContentsWordCheckDto implements ExcelDto {
